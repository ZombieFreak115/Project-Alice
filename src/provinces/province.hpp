...
void make_military_supply_path(const sys::state& state, dcon::state_instance_id start_si, dcon::province_id end, dcon::nation_id nation_as, std::vector<dcon::province_id>& path_result);
