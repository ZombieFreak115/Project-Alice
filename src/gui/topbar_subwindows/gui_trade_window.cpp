...
public:
	...
	enum class value_type : uint8_t {
		used_by, produced_by, may_be_used_by
	} value_type{};
	union {
...
bool compare_balance(sys::state& state, element_base* container, dcon::commodity_id a, dcon::commodity_id b) {
	...
	auto balance_a = (supply_a + 0.0001f) / (demand_a + 0.0001f);;

	auto supply_b = economy::supply(state, b);
	auto demand_b = economy::demand(state, b);
	auto balance_b = (supply_b + 0.0001f) / (demand_b + 0.0001f);;
...
static table::column<dcon::commodity_id> trade_good_name_column = {
	.sortable = true,
...
static table::column<dcon::commodity_id> trade_good_price_column = {
	.sortable = true,
	.header = "price",
...
static table::column<dcon::commodity_id> trade_good_supply_column = {
	.sortable = true,
	.header = "supply",
...
static table::column<dcon::commodity_id> trade_good_demand_column = {
	.sortable = true,
	.header = "demand",
...
static table::column<dcon::commodity_id> trade_good_balance_column = {
	.sortable = true,
	.header = "balance",
...
static table::column<dcon::commodity_id> trade_good_market_stockpile_column = {
	.sortable = true,
...
static table::column<dcon::commodity_id> trade_good_player_stockpile_column = {
	.sortable = true,
...
static table::column<dcon::commodity_id> trade_good_player_gov_needs = {
	.sortable = true,
...
static table::column<dcon::commodity_id> trade_good_player_price = {
	.sortable = true,
	.header = "price_nation",
	.compare = [](sys::state& state, element_base* container, dcon::commodity_id a, dcon::commodity_id b) {
...
static table::column<dcon::commodity_id> trade_good_player_factory_needs = {
	.sortable = true,
	.header = "factory_need",
	.compare = [](sys::state& state, element_base* container, dcon::commodity_id a, dcon::commodity_id b) {
...
static table::column<dcon::commodity_id> trade_good_player_production_artisan = {
	.sortable = true,
...
static table::column<dcon::commodity_id> trade_good_player_pop_needs = {
	.sortable = true,
	.header = "pop_need",
	.compare = [](sys::state& state, element_base* container, dcon::commodity_id a, dcon::commodity_id b) {
...
static table::column<dcon::commodity_id> trade_good_production_rgo = {
	.sortable = true,
...
static table::column<dcon::commodity_id> trade_good_production_artisan = {
	.sortable = true,
	.header = "artisan_production",
	.compare = [](sys::state& state, element_base* container, dcon::commodity_id a, dcon::commodity_id b) {
		auto av = 0.f;
...
static table::column<dcon::commodity_id> trade_good_production_factory = {
	.sortable = true,
...
static table::column<dcon::commodity_id> trade_good_satisfaction = {
	.sortable = true,
	.header = "artisan_distribution",
	.compare = [](sys::state& state, element_base* container, dcon::commodity_id a, dcon::commodity_id b) {
...
static table::column<dcon::commodity_id> trade_good_produced_nation = {
	.sortable = true,
...
static table::column<dcon::commodity_id> trade_good_consumed_nation = {
	.sortable = true,
...
static table::column<dcon::nation_id> nation_price = {
	.sortable = true,
	.header = "price_nation",
...
static table::column<dcon::nation_id> trade_table_nation_name = {
	.sortable = true,
	.header = "nation_name",
	.compare = [](sys::state& state, element_base* container, dcon::nation_id a, dcon::nation_id b) {
...
static table::column<dcon::nation_id> nation_production = {
	.sortable = true,
	.header = "produced_nation",
	.compare = [](sys::state& state, element_base* container, dcon::nation_id a, dcon::nation_id b) {
		dcon::commodity_id good = retrieve<dcon::commodity_id>(state, container);
...
static table::column<dcon::nation_id> nation_demand = {
	.sortable = true,
...
static table::column<dcon::nation_id> nation_consumption = {
	.sortable = true,
	.header = "consumed_nation",
	.compare = [](sys::state& state, element_base* container, dcon::nation_id a, dcon::nation_id b) {
		dcon::commodity_id good = retrieve<dcon::commodity_id>(state, container);
...
static table::column<dcon::market_id> market_name = {
	.sortable = true,
	.header = "market_name",
...
static table::column<dcon::market_id> market_production = {
	.sortable = true,
	.header = "produced_nation",
	.compare = [](sys::state& state, element_base* container, dcon::market_id a, dcon::market_id b) {
		dcon::commodity_id good = retrieve<dcon::commodity_id>(state, container);
...
static table::column<dcon::market_id> market_demand = {
	.sortable = true,
	.header = "demanded_nation",
	.compare = [](sys::state& state, element_base* container, dcon::market_id a, dcon::market_id b) {
		dcon::commodity_id good = retrieve<dcon::commodity_id>(state, container);
...
static table::column<dcon::market_id> market_consumption = {
	.sortable = true,
	.header = "consumed_nation",
	.compare = [](sys::state& state, element_base* container, dcon::market_id a, dcon::market_id b) {
		dcon::commodity_id good = retrieve<dcon::commodity_id>(state, container);
...
static table::column<dcon::market_id> market_stockpile = {
	.sortable = true,
...
static table::column<dcon::market_id> market_price = {
	.sortable = true,
	.header = "price_market",
	.compare = [](sys::state& state, element_base* container, dcon::market_id a, dcon::market_id b) {
		dcon::commodity_id good = retrieve<dcon::commodity_id>(state, container);
...
static table::column<dcon::market_id> market_artisan_profit = {
	.sortable = true,
...
static table::column<dcon::market_id> market_artisan_score = {
	.sortable = true,
...
void trade_window::on_update(sys::state& state) noexcept {
