...
void build_unit_large_window::on_create(sys::state& state) noexcept {
	window_element_base::on_create(state);
	set_visible(state, false);
}

std::unique_ptr<element_base> build_unit_large_window::make_child(sys::state& state, std::string_view name, dcon::gui_def_id id) noexcept {
...
void build_unit_large_window::set_army_visible(sys::state& state) {
...
void build_unit_large_window::set_army_invisible(sys::state& state) {
	for(auto element : army_elements)
		element->set_visible(state, false);
}

void build_unit_large_window::set_navy_visible(sys::state& state) {
...
void build_unit_large_window::set_navy_invisible(sys::state& state) {
	for(auto element : navy_elements)
		element->set_visible(state, false);
}

message_result build_unit_large_window::set(sys::state& state, Cyto::Any& payload) noexcept  {
	if(payload.holds_type<dcon::army_id>()) {
...
message_result build_unit_large_window::get(sys::state& state, Cyto::Any& payload) noexcept  {
	if(payload.holds_type<element_selection_wrapper<dcon::unit_type_id>>()) {
...
void build_unit_province_window::on_create(sys::state& state) noexcept {
	window_element_base::on_create(state);
	set_visible(state, false);
}

std::unique_ptr<element_base> build_unit_province_window::make_child(sys::state& state, std::string_view name, dcon::gui_def_id id) noexcept {
	if(name == "cancel_all_units") {
...
message_result build_unit_province_window::get(sys::state& state, Cyto::Any& payload) noexcept {
	if(payload.holds_type<dcon::army_id>()) {
