...
template float get_single_promotion_demotion_target_weight<promotion_type::demotion>(sys::state& state, dcon::pop_id p, dcon::pop_type_id target_type);
template float get_single_promotion_demotion_target_weight<promotion_type::promotion>(sys::state& state, dcon::pop_id p, dcon::pop_type_id target_type);
...
template promotion_demotion_weights get_pop_promotion_demotion_weights<promotion_type::demotion>(sys::state& state, dcon::pop_id p);
template promotion_demotion_weights get_pop_promotion_demotion_weights<promotion_type::promotion>(sys::state& state, dcon::pop_id p);
...
template pop_promotion_demotion_data get_promotion_demotion_data<promotion_type::promotion>(sys::state& state, dcon::pop_id p, float promotion_or_demotion_chance);
template pop_promotion_demotion_data get_promotion_demotion_data<promotion_type::demotion>(sys::state& state, dcon::pop_id p, float promotion_or_demotion_chance);
